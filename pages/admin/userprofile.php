...
<head>
    ...
    <link href="../../web/css/bootstrap-switch.css" rel="stylesheet">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="switch has-switch" id="mySwitch"  style="margin-bottom: 10px" >
                    <input name="my-checkbox"  type="checkbox"  <?php if($user->getStatus()==1) echo  "checked"?> />
                </div>
            </div>
            <!-- /.col-lg-12 -->
...
<script src="../../web/js/bootstrap-switch.js"></script>
<script>
